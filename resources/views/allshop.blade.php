                        ...
                        <div class="goodList mui-scroll">
                            ...
                            @foreach($goodsInfo as $k=>$v)
                                <li id="23468">    
                                    ...
                                    <a href="{{url('shopcontent')}}?goods_id={{$v->goods_id}}"><img class="lazy" src="/storage/goodsImg/{{$v->goods_img}}"></a>
                                    </span>
                                    <div class="gList_r">        
    ...
    function pulldownRefresh() {
        setTimeout(function() {
            ...
            for (var i = cells.length, len = i + 3; i < len; i++) {
                ...
                str += '<img class="lazy" data-original="/storage/goodsImg/{{$v->goods_img}}" src="/storage/goodsImg/{{$v->goods_img}}" style="display: block;"/>';
                str += '</span>';

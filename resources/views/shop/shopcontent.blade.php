            ...
            <a href="/" class="m-index-icon"><i class="m-public-icon"></i></a>
                ...
                <div class="hotimg-wrapper">
                    ...
                    <section id="gallery" class="hotimg">
                        <ul class="slides" style="width: 600%; transition-duration: 0.4s;">
                            <li style="width: 400; float: left; display: block;" class="clone">
                        
                                <a href="">
                                    <img src="/storage/goodsImg/{{$res->goods_img}}" alt="">
                                </a>
                            </li>
                        </ul>
                    </section>
